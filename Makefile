...
COMPILE_OPTS =		$(INCLUDES) -I/usr/local/include -I. -O2 -DSOCKLEN_T=socklen_t -D_LARGEFILE_SOURCE=1 -D_FILE_OFFSET_BITS=64 -DDISABLE_LOOPBACK_IP_ADDRESS_CHECK -fPIC
C =			c
C_COMPILER =		cc
